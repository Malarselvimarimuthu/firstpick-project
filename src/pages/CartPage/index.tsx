      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6">
        ...
        {cartItems.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-10">
            ...
            <p className="text-gray-600 text-lg mt-4">Your cart is empty. Start shopping!</p>
          </div>
        ) : (
            ...
            <div className="w-full lg:flex-grow">
              <div className="bg-white rounded-lg p-4 sm:p-6 shadow-sm">
                ...
                <div className="hidden md:grid grid-cols-[4fr_1fr_2fr_2fr_1fr] border-b pb-2">
                  <div><h3 className="font-medium">Product</h3></div>
                  <div><h3 className="font-medium">Price</h3></div>
                  <div className="text-center"><h3 className="font-medium">Quantity</h3></div>
                  <div><h3 className="font-medium">Total Price</h3></div>
                  <div className="text-center"><h3 className="font-medium">Delete</h3></div>
                </div>
                  ...
                  <div key={item.id} className="flex flex-col md:grid md:grid-cols-[4fr_1fr_2fr_2fr_1fr] py-4 border-b items-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full md:w-auto">
                      <div className="w-full sm:w-auto flex justify-center sm:justify-start">
                        <img src={item.mainImage} alt={item.name} className="w-[140px] h-[180px] sm:w-[160px] sm:h-[200px] object-contain rounded-lg" />
                      </div>
                    ...
                    <div className="flex justify-center w-full md:w-auto mt-4 md:mt-0">
                      <div className="flex items-center border rounded">
                        <button onClick={() => updateQuantity(item.id, item.quantity - 1)} className="px-3 sm:px-2 py-1 hover:bg-gray-100">-</button>
                        <input type="text" value={item.quantity} className="w-12 sm:w-8 text-center border-x" readOnly />
                        <button onClick={() => updateQuantity(item.id, item.quantity + 1)} className="px-3 sm:px-2 py-1 hover:bg-gray-100">+</button>
                      </div>
                    </div>
