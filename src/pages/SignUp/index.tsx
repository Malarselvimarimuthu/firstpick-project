...
//   // Handle manual sign-up with OTP logic
//   const handleManualSignUp = async (e: React.FormEvent) => {
//     e.preventDefault();
...
//       setIsVerified(true); // Show verification input
//       setEmail("");
//       setPassword("");
//       setReEnterPassword("");
//       setError("");

//       // Simulate sending OTP (replace with email sending logic)
...
//       // Clean up: delete OTP after successful verification
